...
All <Link href="/swiper-api#events">Swiper events</Link> are available as native DOM events <b>but with lowecase names</b>. E.g. `slideChange` becomes `slidechange`.
