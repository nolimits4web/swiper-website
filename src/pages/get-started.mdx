...
<div className="important-note md:mr-[340px] space-y-4">
  ...
  <div>If you are looking for v8 docs, they are here{' '}
  <a href="https://v8.swiperjs.com" target="_blank">v8.swiperjs.com</a>
  </div>
</div>
...
If you want to import Swiper with all modules (bundle) then it should be imported from `swiper/swiper-bundle`:
