...
import ModuleTitle from '@/components/ModuleTitle.js';
...
{/* prettier-ignore */}
<div className="important-note space-y-4">
  <div>If you are upgrading from Swiper 9 to Swiper 10, check out{' '} <a href="/migration-guide-v10">Migration Guide to Swiper 10</a></div>
</div>
...
<ModuleTitle module="navigation" id="navigation" title="Navigation" />
...
<ModuleTitle module="pagination" id="pagination" title="Pagination" />
...
<ModuleTitle module="scrollbar" id="scrollbar" title="Scrollbar" />
...
<ModuleTitle module="autoplay" id="autoplay" title="Autoplay" />
...
<PremiumCallout products={[
  { title: 'Stories Slider', url: 'https://uiinitiative.com/catalog/stories-slider', description: 'Instagram-style stories with progress bars' },
  { title: 'Super Flow', url: 'https://uiinitiative.com/catalog/super-flow', description: 'Dynamic triangle fragment effect' },
]} />

<ApiDivider />

<ModuleTitle module="freemode" id="free-mode" title="Free Mode" />
...
<ModuleTitle module="grid" id="grid" title="Grid" />
...
<ModuleTitle module="manipulation" id="manipulation" title="Manipulation" />
...
<ModuleTitle module="parallax" id="parallax" title="Parallax" />
...
<PremiumCallout products={[
  { title: 'Super Flow', url: 'https://uiinitiative.com/catalog/super-flow', description: 'Parallax triangle fragments' },
  { title: 'Shutters Slider', url: 'https://uiinitiative.com/catalog/shutters-slider', description: 'Venetian blinds parallax effect' },
]} />

<ApiDivider />

<ModuleTitle module="lazy" id="lazy-loading" title="Lazy Loading" />
...
<ModuleTitle module="fade" id="fade-effect" title="Fade Effect" />
...
<PremiumCallout products={[
  { title: 'Carousel Slider', url: 'https://uiinitiative.com/catalog/carousel-slider', description: 'True 3D infinite carousel' },
  { title: 'Super Flow', url: 'https://uiinitiative.com/catalog/super-flow', description: 'Dynamic triangle fragments' },
]} />

<ApiDivider />

<ModuleTitle module="flip" id="flip-effect" title="Flip Effect" />
...
<ModuleTitle module="cube" id="cube-effect" title="Cube Effect" />
...
<ModuleTitle module="cards" id="cards-effect" title="Cards Effect" />
...
<PremiumCallout products={[
  { title: 'Tinder Slider', url: 'https://uiinitiative.com/catalog/tinder-slider', description: 'Swipe direction detection + callbacks' },
  { title: 'Cards Stack Slider', url: 'https://uiinitiative.com/catalog/cards-stack-slider', description: 'Front/back card sides' },
]} />

<ApiDivider />

<ModuleTitle module="creative" id="creative-effect" title="Creative Effect" />
...
<PremiumCallout products={[
  { title: 'Shaders Slider', url: 'https://uiinitiative.com/catalog/shaders-slider', description: '20+ WebGL shader transitions' },
  { title: 'Super Flow', url: 'https://uiinitiative.com/catalog/super-flow', description: 'Dynamic triangle fragments' },
  { title: 'Material You Slider', url: 'https://uiinitiative.com/catalog/material-you-slider', description: 'Google Material You design' },
]} />

<ApiDivider />

<ModuleTitle module="thumbs" id="thumbs" title="Thumbs" />
...
<ModuleTitle module="zoom" id="zoom" title="Zoom" />
...
<ModuleTitle module="keyboard" id="keyboard-control" title="Keyboard Control" />
...
<ModuleTitle module="virtual" id="virtual-slides" title="Virtual Slides" />
...
<ModuleTitle module="hash" id="hash-navigation" title="Hash Navigation" />
...
<ModuleTitle module="control" id="controller" title="Controller" />
