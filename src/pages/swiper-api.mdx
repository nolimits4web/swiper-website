...
- `components/controller/controller.min.css` - styles required for A11y module
...
- `components/controller/controller.less` - styles required for A11y module
...
- `components/controller/controller.scss` - styles required for A11y module
...
<table className="table-fixed params-table">
  ...
  <tbody>
    <tr className="border-t">
      <td className="w-1/6 text-red-700 font-mono font-semibold">parallax</td>
      <td className="w-1/6 text-green-700 font-mono font-semibold">
        ParallaxOptions{' | '}boolean
      </td>
...
`}</code></pre>
    ...
    <tr className="border-t params-table-nested-row">
      <td className="w-1/6 text-red-700 font-mono font-semibold">enabled</td>
      <td className="w-1/6 text-green-700 font-mono font-semibold">boolean</td>
      <td className="w-1/6 text-red-700 font-mono font-semibold">false</td>
      <td className="w-3/6 space-y-2">
        <p>Enable, if you want to use "parallaxed" elements inside of slider</p>
      </td>
    </tr>
...
<div className="important-note">
  Note that <code>crossFade</code> should be set to <code>true</code>{' '}
  in order to avoid seeing content behind or underneath.
</div>
