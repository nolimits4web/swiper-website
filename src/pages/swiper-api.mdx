...
{/* prettier-ignore */}
<div className="important-note">Note that <code>mode</code> should be set to <code>'cross-fade'</code> or <code>'out-in'</code> in order to avoid seeing content behind or underneath.</div>
