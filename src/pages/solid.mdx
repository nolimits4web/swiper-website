...
<div className="important-note">
  By default Swiper SolidJS uses core version of Swiper (without any additional
...
<div className="important-note">
  Note, Swiper SolidJS component will create required elements for Navigation,
...
`Swiper` SolidJS component receive all <a href="/swiper-api/#parameters">Swiper parameters</a> as component props, plus some extra props:
