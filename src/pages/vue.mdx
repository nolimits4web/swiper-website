...
<div className="important-note space-y-4 md:mr-[340px]">
  <div>
    <b>
      Swiper Vue components will likely to be removed in future versions. It is
      recommended to migrate to <a href="/element">Swiper Element</a> instead.
    </b>
  </div>
  <div>
    If you are upgrading from Swiper 8 to Swiper 9, check out{' '}
    <a href="/migration-guide-v9">Migration Guide to Swiper 9</a>
  </div>
  <div>
...
<div className="important-note">
  ...
  <a href="/swiper-api/#custom-build">other modules</a>, you have to install
  them first.
</div>
