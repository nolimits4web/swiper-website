...
export default function Footer() {
  ...
  return (
    <>
      ...
      {!removeBanner && (
        <a
          href="https://devhunt.org/tool/swiper-studio"
          target="_blank"
          className={`sticky bottom-0 z-[1000] flex flex-wrap  items-center justify-center gap-4 border-t border-[#f97316] bg-black px-4 py-4 text-sm text-white duration-700 hover:no-underline ${
            banner
              ? 'translate-y-0'
        ...
        >
          ...
          <span className="">Support Swiper Studio on</span>
          ...
          <span className="opacity-50">Voting ends on Oct 2nd</span>
        </a>
      )}
    </>
  );
